...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="float-fight mt-4">logout</div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col=md-3">
                ...
                <ul class="nav-flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link" href="?f=menu&m=selec">Mneu</a></li>
        ...
        <div class="row mt-5">
            ...
            <div class="col">
                <p class="text-center">2019 - copyright@SMKN2Buduran.com</p>
            </div>
        </div>
